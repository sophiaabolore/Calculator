...
//  Calculator
//
//  Created by Manrex Graphics on 2020-08-10.
//  Copyright © 2020 Manrex Graphics. All rights reserved.
//
...
private func setupNumberPad()
{
    ...
    resultLabel.frame = CGRect(x: 20, y: holder.frame.size.height-buttonSize*CGFloat(6), width: view.frame.size.width-40, height: 100)
